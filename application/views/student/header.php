...
else if($pagename=='mycourse')
{
  $stu_id=$_SESSION['auth_login_unboxskills_student'];
  $myCourse=$this->admin->get_student_course($stu_id);
           ...
           <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-toggle="dropdown" id="profileDropdown">
            ...
            <div class="d-flex align-items-center pt-2 pr-2 ">
                <div class="box" style="position:relative;">
                  ...
                  <h6 style="position: absolute; top:50%; left:50%; transform: translate(-50%,-100%); font-size:11px ">
                    <?= $totalComplPer ?>%</h6>
               </div>
            </div>
      ...
      <div class="modal-body py-5">
        ...
        <div class="d-flex align-items-center justify-content-center">
          <div class="bor_3 d-flex">
           <input type="text" name="" class="py-2 px-2 border-0" value="<?=base_url('/')?> " >
           <button class="btn btn-dark px-2 text-white bg_9 rounded-0 border-0 ml-0">Copy</button>
          </div>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-center my-3">
          ...
          <i class="fas fa-envelope mr-2 f_25 bs_1 bor_1 p-2 tc_5 cp rt_16"></i>
        </div>
      </div>
    </div>
  </div>
