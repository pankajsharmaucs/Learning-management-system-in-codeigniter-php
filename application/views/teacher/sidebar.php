  <nav class="sidebar sidebar-offcanvas teachersidebar" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= $_SESSION['dash_url'].'create_course'; ?>">
              <i class="icon-grid menu-icon"></i>
           ...
           <li class="nav-item">
            <a class="nav-link" href="<?= $_SESSION['dash_url'].'create_announce'; ?>">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Course Announcment</span>
            </a>
          </li>
