        ...
        <div class="row Dashboard_wrapper">
              ...
              <div class="dashboard_left_main col-xl-2 col-lg-3 col-md-12 d-none d-xl-block d-lg-block col-sm-12 col-12 p-0">
               <div class="dashboard_left bg_2 h-100  d-flex justify-content-center">
                   <ul class="w-100 h-100 pt-4" type="none">
                        ...
                        <li id="tab1" class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500  tab1" onclick="desktopSideBarBtn(1)">
                          <img src="<?=base_url('assets/')?>user_dashboard_e/svg/dashboard.svg" alt="" width="18px" class="mr-1"> Dashboard</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab2" onclick="desktopSideBarBtn(2)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/list.svg" alt="" width="18px" class="mr-1"> Company List</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab3" onclick="desktopSideBarBtn(3)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/trolley.svg" alt="" width="18px" class="mr-1"> Cart</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab4" onclick="desktopSideBarBtn(4)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/history.svg" alt="" width="18px" class="mr-1"> Purchase History</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab5" onclick="desktopSideBarBtn(5)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/wallet-2.svg" alt="" width="18px" class="mr-1"> Wallet</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab6" onclick="desktopSideBarBtn(6)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/bell.svg" alt="" width="18px" class="mr-1"> Notification <span class="bg-white tc_6 f_14 px-1 rounded">8</span></li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab7" onclick="desktopSideBarBtn(7)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/technical-support.svg" alt="" width="18px" class="mr-1"> Support</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab8" onclick="desktopSideBarBtn(8)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/management.svg" alt="" width="18px" class="mr-1"> Profile Setting</li>

                        <li class=" px-2 pl-xl-3 pl-lg-3  py-2 fw_500 tab8" onclick="desktopSideBarBtn(9)"> <img src="<?=base_url('assets/')?>user_dashboard_e/svg/password.svg" alt="" width="18px" class="mr-1"> Reset Password</li>
                   </ul>
               </div>
            </div>
           ...
           <!-- ========mobile sidebar=============== -->
            <div class="dashboard_mobile_sidebar w-100 h-100 ">
                   ...
                   <div class=" d-flex justify-content-start align-items-center w-100 p-2" style="margin-top: -10px;">
            ...
            <div class="col-xl-8 col-lg-9 col-md-12 col-sm-12 col-12 p-0 bg_6 pl-lg-0 pl-xl-0 pl-md-0 pl-3 dashboard_right_main">
               <div class="d-flex flex-wrap justify-content-xl-between justify-content-lg-between align-items-center justify-content-between dashboard_right bg_6 p-3">
             
                 <div class="">
                   <h3 class=" fw_400  dashTitle ">Home</h3>
                 </div>
