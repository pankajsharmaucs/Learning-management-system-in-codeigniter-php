    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 p-0 flex-wrap">
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-center  f_18 rt_15 fw_500 ">
          ...
          <div class="profile_img pt-3  shadow-sm d-flex justify-content-center pb-2">
            <div>
              <div id="validationChangePass" style="display:none"></div>
              <form id="changePasswordForm  " action="" method="post">
                <div class="form-group text-left">
                  <label for="" class="f_15">Old Password</label>
                  <input type="text" name="oldPassword" id="oldPassword" class="form-control border" placeholder="Enter Old Password">
                </div>
                <div class="form-group text-left">
                  <label for="" class="f_15">New Password</label>
                  <input type="text" name="newPassword" id="newdPassword" class="form-control border" placeholder="Enter New Password">
                </div>
