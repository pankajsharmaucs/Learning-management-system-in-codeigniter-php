<!-- =======Notification ====== -->
                ...
                <div class="company_list_body ad_notification_body dashboard_body p-xl-3 p-lg-3 p-md-3" id="desktopMainPannel_6">
                   <div class="row col-lg-12 col-12 ">
                        ...
                        <div class="col-xl-12 col-lg-12 bg_7 col-md-12 col-sm-12 col-12 d-flex justify-content-between align-items-center  p-0 flex-wrap">
                         <div class="d-flex justify-content-start align-items-center text-center  flex-wrap">
                              <div class="m-1 px-2 py-1 f_18 fw_600 rounded f_15 rt_18">Notification</div>
                            </div>
                       </div>

                       <!-- -table-1 -->
                      
                       <div class="col-12 p-0 m-1 notification " >
                        ...
                        <div class="table-responsive">
                          ...
                          <tbody>
                             <tr class="text-center">
                              ...
                              <td class="f_14 align-middle text-nowrap fw_600">John</td>
                              ...
                              <td class="f_14 align-middle text-nowrap">01-02-2021 22:15</td>
                               <td class="f_14 d-flex justify-content-center align-middle align-items-center">
                                <div class="pt-2">
                                 <span class="bg_4 text-decoration-none  text-white py-2 px-2 rounded cp notification_view_btn">View</span>
                                </div>
                              </td>
                   ...
                   <div class="ad_notification_view py-2 pb-3">
                     <div class="col-xl-12 col-lg-12 bg_7 col-md-12 col-sm-12 col-12 d-flex justify-content-between align-items-center  p-0 flex-wrap">
                         <div class="d-flex justify-content-start align-items-center text-center  flex-wrap">
                              <div class="m-1 px-2 py-1 f_18 fw_600 rounded f_15 rt_15">Notification View</div>
                            </div>
                       </div>

                     <span class="rt_13 f_13 pl-3 tc_2 cp notification_view_back_btn pt-1"><img src="<?=base_url('assets/')?>admin_dashboard_e/svg/right-arrow.svg" width="20px" alt="icon" class="mr-1" style="transform: rotate(180deg);"> Back to notification</span>
                        ...
                        <div class="card_1 p-4 bg-white">
                             ...
                             <div class="">
                              <div>
                                ...
                                <h4 class="f_15 fw_400">Notification: <span class="fw_300 tc_1">lorem</span></h4>
                              </div>
                               <div class="">
                                <h4 class="f_15 fw_400">Date: <span class="fw_300 tc_1">abc</span></h4>
                               </div>
                             </div>
                        </div>
                     </div>
