...
<section class="login_section py-md-4 bgi_2">
<div class="container px-lg-5 ">
  <div class="row bs_1">
    <div class="col-md-6 bg_9">
     <div class="login_left_content align-items-start pt-md-5 pt-2 d-flex h-100 justify-content-center">
       <div>
        ...
        <h1 class="text-white fw_400 f_32 rt_16 text-center py-2">Recover Account</h1>
    ...
    <div class="col-md-6 bg-white px-lg-5 px-2">
      <div class="login1">
         <form>
            <!-- <h2 class="title rt_25 fw_500 text-dark"> Sign In</h2> -->
            <p class="subtitle rt_13 f_14 mt-2 text-secondary">have an account? <a href="<?= base_url(); ?>login"> Login</a></p>
            ...
            <button class="button46 w-100 d-block border-0 mt-2 mb-2">Submit</button>
         </form>
      </div>
    </div>
  </div>
