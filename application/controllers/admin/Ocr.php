 ...
 for($i=0;$i<$temp;$i++){
   ...
   $BalanceSheet[] = array(
    ...
    'SubHead' => $b_SubHead[$j],
     ...
     'FinancialYear'=>$b_FinancialYear1[$j],
    );
  }
 ...
 for($k=0;$k<$temp2;$k++){
  ...
  for($l=0;$l<$temp3;$l++){
   $ProfitAndLoss[] = array(
    ...
    'SubHead' => $p_SubHead[$l],
     'Value'=>$value4[$l],
  'FinancialYear'=>$p_FinancialYear1[$l],
...
$url ="http://103.108.220.175/CentralWebService/ConsumeAOC.asmx/InsertAOCDataINCWS";
$ch = curl_init( $url );
...
//echo $obj['BSHead'][];
echo $obj['d']['ResponseCode'].'_'.$obj['d']['ResponseMessage'];
//print_r($result);
curl_close($ch);
...
//print_r($payload); 
 ...
 for($t=0;$t<$typecount;$t++){
    ...
    $share_type=$this->input->post('share_type'.$type[$t]);
    $share_category=$this->input->post('share_category'.$type[$t]);
    $share_category_no=$this->input->post('share_category_no'.$type[$t]);
    $share_description=$this->input->post('share_description'.$type[$t]);
    $name_ofshare_holder=$this->input->post('name_ofshare_holder'.$type[$t]);
    $no_of_share=$this->input->post('no_of_share'.$type[$t]);
    $percentage=$this->input->post('percentage'.$type[$t]);
...
//print_r($payload);  exit;
 ...
 for($t=0;$t<$typecount;$t++){
    ...
    $main_head=$this->input->post('main_head'.$type[$t]);
    $head=$this->input->post('Head'.$type[$t]);
    $sub_head=$this->input->post('MainHead'.$type[$t]);
    $value=$this->input->post('value'.$type[$t]);
    $date=$this->input->post('year'.$type[$t]);

    $main_head2=$this->input->post('main_headpl'.$type[$t]);
    $head2=$this->input->post('Headpl'.$type[$t]);
    $sub_head2=$this->input->post('MainHeadpl'.$type[$t]);
    $value2=$this->input->post('valuepl'.$type[$t]);
    $datepl=$this->input->post('yearpl'.$type[$t]);
...
$url ="http://103.108.220.175/CentralWebService/ConsumeLLPForm-8Data.asmx/InsertLLPDataINCWS";
...
//print_r($payload);  exit;
 ...
 for($t=0;$t<$typecount;$t++){
     ...
     $PartnerName=$this->input->post('PartnerName'.$type[$t]);
    $Designation=$this->input->post('Designation'.$type[$t]);
    $Contribution=$this->input->post('Contribution'.$type[$t]);
...
$obj = @json_decode($json,true);
     ...
     $var.= '<option value="'.$obj1[$i]['HeadID'].'">'.$obj1[$i]['SubHead'].'</option>';
      ...
      $html='<tr class="rows"><td>
                            <select class="form-control" name="main_head'.$type.'[]" onchange="getRow_feedback('.$row.','.$type.')" id="main_head'.$row.$type.'" style="margin-left:-10px;">'.$var. '</select>
                              </td>
                               <td>
                               <input type="text" name="Head'.$type.'[]" class="form-control" id="Head'.$row.$type.'" style="margin-left:-10px;">
                              </td>
                              <td>
                              <input type="text" name="MainHead'.$type.'[]" class="form-control" id="MainHead'.$row.$type.'" style="margin-left:-10px;">
                              </td>
                             <td>
                               <input type="text" name="value'.$type.'[]" class="form-control" id="value'.$row.$type.'" style="margin-left:-10px;">
                             </td>
                                <td>
                               <select  class="form-control form-control-sm " name="year'.$type.'[]"  id="year'.$row.$type.'">
     ...
     echo $html;exit;
      ...
      public function getpldata($type)
     {     $month=(int)date("m");
             if($month<4){
               $year=date("Y")-1;
             }else{
...
$obj = @json_decode($json,true);
     ...
     $var.= '<option value="'.$obj1[$i]['HeadID'].'">'.$obj1[$i]['SubHead'].'</option>';
      ...
      $html='<tr class="rows"><td>
                            <select class="form-control" name="main_head'.$type.'[]" onchange="getplRow_feedback('.$row.','.$type.')" id="main_headpl'.$row.$type.'" style="margin-left:-10px;">'.$var. '</select>
                              </td>
                               <td>
                               <input type="text" name="Head'.$type.'[]" class="form-control" id="Headpl'.$row.$type.'" style="margin-left:-10px;">
                              </td>
                              <td>
                              <input type="text" name="MainHead'.$type.'[]" class="form-control" id="MainHeadpl'.$row.$type.'" style="margin-left:-10px;">
                              </td>
                             <td>
                               <input type="text" name="value'.$type.'[]" class="form-control" id="valuepl'.$row.$type.'" style="margin-left:-10px;">
                             </td>
                                 <td>
                                 <select  class="form-control form-control-sm " name="yearpl'.$type.'[]"  id="yearpl'.$row.$type.'">
             <option value=""   selected >Year</option>
             <option value="'.$year.'">'.$year.'</option>
            <option value="'.$year1.'">'.$year1.'</option>
            <option value="'.$year2.'">'.$year2.'</option>
