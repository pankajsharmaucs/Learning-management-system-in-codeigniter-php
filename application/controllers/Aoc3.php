...
class Aoc extends CI_Controller
{
    ...
    public function compress()
    {
        ...
        $data['output']=$this->Ocr_model->do_ocr($data['id'],$data['tracking_id'],$data['input'],$data['type'],$heads,$data['Category']);
        $data['status']="200";
        $data['msg']='Success';
...
// }
    ...
    public function mgtjson()
    {
      ...
      $pdf="http://kreditaid.com/uat/".$_POST['file'];
      $data['mgt']='http://kreditaid.com/uat/'.$_POST['json_file'];
    ...
    public function aocjson()
    {
      ...
      $tracking_id=$_POST['tracking_id'];
      $pdf="http://kreditaid.com/uat/".$_POST['file'];
      $data['aoc_json']='http://kreditaid.com/uat/'.$_POST['json_file'];
